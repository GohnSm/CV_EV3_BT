...
if hmm == 'n':
    ...
    while True:
        ...
        while (ret==True):	
            ...
            if n1v>3200:
                print('!!!   1 ',cn)
                gpio1=open('/sys/class/gpio/gpio3/value','w')
                gpio1.write('1')
                gpio1.close
                gpio2=open('/sys/class/gpio/gpio4/value','w')
                gpio2.write('1')
                gpio2.close
                gpio3=open('/sys/class/gpio/gpio'+cl+'/value','w')
                gpio3.write('1')
                gpio3.close
                time.sleep(10)
                gpio4=open('/sys/class/gpio/gpio'+cl+'/value','w')
                gpio4.write('0')
                gpio4.close
                gpio5=open('/sys/class/gpio/gpio3/value','w')
                gpio5.write('0')
                gpio5.close
                gpio6=open('/sys/class/gpio/gpio4/value','w')
                gpio6.write('0')
                gpio6.close
                break
            elif n2v>3160:
                ...
                gpio2.write('1')
                gpio2.close
                gpio7=open('/sys/class/gpio/gpio14/value','w')
                gpio7.write('1')
                gpio7.close
                gpio8=open('/sys/class/gpio/gpio15/value','w')
                gpio8.write('1')
                gpio8.close
                gpio3=open('/sys/class/gpio/gpio'+cl+'/value','w')
                gpio3.write('1')
                gpio3.close
                time.sleep(10)
                gpio9=open('/sys/class/gpio/gpio14/value','w')
                gpio9.write('0')
                gpio9.close
                gpio10=open('/sys/class/gpio/gpio15/value','w')
                gpio10.write('0')
                gpio10.close
                gpio4=open('/sys/class/gpio/gpio'+cl+'/value','w')
                gpio4.write('0')
                gpio4.close
                gpio5=open('/sys/class/gpio/gpio2/value','w')
                gpio5.write('0')
                gpio5.close
                gpio6=open('/sys/class/gpio/gpio3/value','w')
                gpio6.write('0')
                gpio6.close
                break
            elif n3v>3000:

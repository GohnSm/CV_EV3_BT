...
if hmm == 'n':
    ...
    gpio1.write('0')
    gpio1.close
    n1=cv.inRange(cv.resize(cv.imread('1.png'),(128,128)),(0,0,0),(2,2,2)) 
    n2=cv.inRange(cv.resize(cv.imread('2.png'),(128,128)),(0,0,0),(2,2,2))  
    n3=cv.inRange(cv.resize(cv.imread('3.png'),(128,128)),(0,0,0),(2,2,2)) 
    n4=cv.inRange(cv.resize(cv.imread('4.png'),(128,128)),(0,0,0),(2,2,2))  
    n5=cv.inRange(cv.resize(cv.imread('5.png'),(128,128)),(0,0,0),(2,2,2))  
    n6=cv.inRange(cv.resize(cv.imread('6.png'),(128,128)),(0,0,0),(2,2,2)) 
    n7=cv.inRange(cv.resize(cv.imread('7.png'),(128,128)),(0,0,0),(2,2,2)) 
    n8=cv.inRange(cv.resize(cv.imread('8.png'),(128,128)),(0,0,0),(2,2,2)) 
    n9=cv.inRange(cv.resize(cv.imread('9.png'),(128,128)),(0,0,0),(2,2,2))   
    n10=cv.inRange(cv.resize(cv.imread('10.png'),(128,128)),(0,0,0),(2,2,2)) 
    n11=cv.inRange(cv.resize(cv.imread('11.png'),(128,128)),(0,0,0),(2,2,2)) 
    n12=cv.inRange(cv.resize(cv.imread('12.png'),(128,128)),(0,0,0),(2,2,2)) 
    cap=cv.VideoCapture(0)                                                                
